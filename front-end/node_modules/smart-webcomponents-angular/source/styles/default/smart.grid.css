...
smart-grid .smart-grid-add-row-button.show:active, smart-grid .smart-grid-add-row-button.show:hover {
  color: var(--smart-primary-color);
  background: var(--smart-primary);
}
smart-grid .smart-grid-add-row-button.show:active.float, smart-grid .smart-grid-add-row-button.show:hover.float {
  transform: scale(1.2);
  box-shadow: var(--smart-elevation-6);
}
smart-grid[appearance_allow-hover] smart-grid-cell:hover {
  background: var(--smart-ui-state-hover);
  color: var(--smart-ui-state-color-hover);
}
smart-grid[appearance_allow-hover] smart-grid-cell:hover .smart-label {
  background: var(--smart-ui-state-hover) !important;
  color: var(--smart-ui-state-color-hover) !important;
}
smart-grid[appearance_allow-hover]:not([selection_allow-cell-selection]) smart-grid-row:hover smart-grid-cell {
  background: var(--smart-ui-state-hover);
  color: var(--smart-ui-state-color-hover);
}
smart-grid[appearance_allow-hover]:not([selection_allow-cell-selection]) smart-grid-row:hover smart-grid-cell .smart-label {
  background: var(--smart-ui-state-hover) !important;
  color: var(--smart-ui-state-color-hover) !important;
}
...
smart-grid-cell .images .btn:hover {
  cursor: pointer;
  background: var(--smart-primary);
  color: var(--smart-primary-color);
}
