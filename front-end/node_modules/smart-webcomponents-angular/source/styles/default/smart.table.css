...
.smart-table[freeze-header] thead {
...
.smart-table[freeze-header] thead th.sticky {
  position: sticky;
}
...
.smart-table[freeze-header][filtering]:not([filter-row]) thead th, .smart-table[freeze-header][conditional-formatting-button] thead th {
  top: var(--smart-table-header-footer-height);
}
.smart-table[freeze-header][filtering]:not([filter-row]) thead tr:nth-child(2) > th, .smart-table[freeze-header][conditional-formatting-button] thead tr:nth-child(2) > th {
  top: calc(var(--smart-table-header-footer-height) + var(--smart-table-column-header-height));
}
.smart-table[freeze-header][filtering]:not([filter-row]) thead tr:nth-child(3) > th, .smart-table[freeze-header][conditional-formatting-button] thead tr:nth-child(3) > th {
  top: calc(var(--smart-table-header-footer-height) + 2 * var(--smart-table-column-header-height));
}
.smart-table[freeze-header][filtering]:not([filter-row]) thead tr:nth-child(4) > th, .smart-table[freeze-header][conditional-formatting-button] thead tr:nth-child(4) > th {
  top: calc(var(--smart-table-header-footer-height) + 3 * var(--smart-table-column-header-height));
}
.smart-table[freeze-header][filtering]:not([filter-row]) thead tr:nth-child(5) > th, .smart-table[freeze-header][conditional-formatting-button] thead tr:nth-child(5) > th {
...
.smart-table[hide-selection-column] .smart-table-select-row .selection-checkbox {
  visibility: hidden;
}
